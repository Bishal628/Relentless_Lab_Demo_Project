...
export const UPLOAD_PURPOSES: Record<UploadPurpose, PurposeConfig> = {
  'news-image': {
    folder: 'relentlesslab/news',
    requiresAdmin: true,
    resourceType: 'image',
    ingestTransformation: IMAGE_INGEST_TRANSFORMATION,
  },
  'achievement-image': {
    folder: 'relentlesslab/achievements',
    requiresAdmin: true,
    resourceType: 'image',
    ingestTransformation: IMAGE_INGEST_TRANSFORMATION,
  },
  'testimonial-photo': {
    folder: 'relentlesslab/testimonials',
    requiresAdmin: true,
    resourceType: 'image',
    ingestTransformation: IMAGE_INGEST_TRANSFORMATION,
  },
  ...
  'programme-cover': {
    folder: 'relentlesslab/programmes',
    requiresAdmin: true,
    resourceType: 'image',
    ingestTransformation: IMAGE_INGEST_TRANSFORMATION,
  },
  ...
  'specialization-image': {
    folder: 'relentlesslab/specializations',
    requiresAdmin: true,
    resourceType: 'image',
    ingestTransformation: IMAGE_INGEST_TRANSFORMATION,
  },
  ...
  // re-upload.
  'leadership-photo': {
    folder: 'relentlesslab/leadership',
    requiresAdmin: true,
    resourceType: 'image',
    ingestTransformation: IMAGE_INGEST_TRANSFORMATION,
  },
  ...
  'download-file': {
    folder: 'relentlesslab/downloads',
    requiresAdmin: true,
    resourceType: 'raw',
