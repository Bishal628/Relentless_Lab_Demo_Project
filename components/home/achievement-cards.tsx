...
export function AchievementCards({
  ...
  return (
    <ScrollableCardDialog
      ...
      eyebrow="Recognition"
      heading="What we have achieved throughout the years."
      // The section sits on a `brand` Band, whose ground is too dark for the
      // header's default --green-brand / --green-ink / --ink-muted set (the
      // eyebrow would be the background's own colour). The cards keep their
      // own --surface and are unaffected.
      onDark
