...
// z=17, not 16: in this iframe's wide, short box z=16 spans most of Lakeview
// and the pin lands in an unlabelled block. z=17 puts Riverside-7, the Lakeview
// Highway and Riverside Ground in frame — the landmarks a visitor actually
// navigates by — without zooming past them.
const MAP_SRC =
  'https://www.google.com/maps?q=27.644730,85.431018&z=17&output=embed';
      ...
      >
        <div className="min-h-0 overflow-hidden">
          {mounted ? (
            <iframe
              src={MAP_SRC}
              title={"Map showing Relentless Lab School & College's location"}
              width="100%"
              height="440"
              style={{ border: 0 }}
              loading="lazy"
