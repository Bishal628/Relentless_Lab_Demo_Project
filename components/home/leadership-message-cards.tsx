...
export function LeadershipMessageCards({
  ...
  return (
    <ScrollableCardDialog
      ...
      heading="A word from the people who lead Relentless Lab"
      ...
      renderCard={(message, trigger) => (
        <ContentCard
          ...
          // heading outline.
          title={message.name}
          meta={<p className="text-small text-signature-ink">{message.title}</p>}
        ...
        <div className="flex min-h-0 flex-auto flex-col">
          <div className="flex items-start gap-4 border-b border-line p-6">
            ...
            <div className="min-w-0 flex-1">
              <h2 id={headingId} className="font-display text-h3 text-ink-950">
                {message.name}
              </h2>
