...
export function ApplyForm({
  ...
  if (state.ok && state.reference) {
    return (
      <div
        role="status"
        // Same width and centre axis as the form it replaces, so confirming a
        // submission does not visibly reflow the column.
        className="mx-auto mt-10 max-w-2xl rounded-lg border border-green-pale bg-green-mist p-8 sm:p-10"
      >
  ...
  // mx-auto centres the CARD within the page's reading column; the fields,
  // labels and legends inside are untouched and stay left-aligned.
  return (
    <form action={formAction} className="mx-auto mt-10 max-w-2xl" noValidate>
