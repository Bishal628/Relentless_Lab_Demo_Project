...
const DESCRIPTION =
  'How students at Relentless Lab School & College grow beyond the classroom — field visits and internships, clubs and co-curricular activities, and the school publications that carry their work.';
...
const SECTIONS: { id: string; title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: 'Relentless Lab students are encouraged to take an active part in extra and co-curricular activities for their overall development. The Student Quality Circle (SQC) Club, Sports Club, Social Club, and Music Club are all active in the school, each organising programmes throughout the year.',
  },
  {
    id: 'publications',
