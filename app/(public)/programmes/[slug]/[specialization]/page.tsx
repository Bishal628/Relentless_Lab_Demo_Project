...
export async function generateMetadata({
  ...
  const description =
    ...
    `${specialization.title}, part of the ${programme.title} programme at Relentless Lab School & College, Lakeview.`;
  ...
  const ogImage = photograph
    ...
    : // The logo is padded on white rather than cropped to fill — c_fill would
      ...
      cloudinaryImage(cloud, 'relentlesslab/logo1', 'c_pad,b_white,w_1200,h_630');
